        ...
        <div className="container mx-auto flex flex-col items-center justify-center px-5 py-10">
          ...
          <div className="mb-16 flex w-full flex-col items-center text-center md:w-2/3">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              rerum laudantium adipisci, saepe quo porro tenetur, mollitia quis
              similique a cum earum sit sunt accusantium voluptatem libero
              aliquam modi minima.
            </p>
            ...
            <div className="flex">
              ...
              <button className="ml-4 inline-flex items-center rounded-lg bg-gray-100 py-3 px-5 hover:bg-gray-200 focus:outline-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="h-6 w-6"
